...
import { b, div } from "framer-motion/m";
export function Hero() {
  return (
    <section className="relative px-4 md:px-20 py-16 md:py-32 lg:py-32 overflow-hidden bg-[#ECEEF0] dark:bg-secondary/0 ">
    <div
    className="  relative"
...
//  backgroundSize: 'cover', backgroundPosition: 'center', opacity:'1' }}   
 />        
      {/* <div className="absolute inset-0 bg-gradient-to-br from-primary/30 rounded-4xl via-transparent to-secondary/30 pointer-events-none z-0" /> */}
      ...
      <div className="relative z-10 max-w-5xl p-20 mx-auto px-4 md:px-8 text-center ">
        ...
        >
          Building Tomorrow's <br className="hidden sm:block" />
          <span className="text-seconda ry  text-[#A2803E] drop-shadow-lg">Intelligent Systems</span>
        </motion.h1>
        ...
        >
          <Button
            size="lg"
            className=" dark:bg-secondary text-shadow-secondary-foreground hover:bg-secondary border border-white/20 px-8 md:px-10 py-5 md:py-6 rounded-sm font-regular text-base md:text-lg transition-all w-full sm:w-auto shadow-xl cursor-pointer"
          >
            Explore Solutions
            <ArrowRight className="w-4 h-4 md:w-5 md:h-5 transition-transform group-hover:translate-x-1" />
